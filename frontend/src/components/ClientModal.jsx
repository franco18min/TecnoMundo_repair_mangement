...
import { X, Loader, User, AtSign, Phone, Fingerprint } from 'lucide-react';
...
export function ClientModal({ isOpen, onClose, client, onClientUpdated }) {
            ...
            >
                ...
                >
                    ...
                    <div className="p-6 border-t bg-gray-50 flex justify-end gap-3">
                        ...
                        <motion.button type="submit" form="edit-client-form" disabled={isSubmitting} className="bg-indigo-600 text-white font-semibold py-2 px-5 rounded-lg shadow-md hover:bg-indigo-700 disabled:bg-indigo-300 flex items-center justify-center" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                            {isSubmitting ? <Loader size={20} className="animate-spin" /> : 'Guardar Cambios'}
                        </motion.button>
                    </div>
                </motion.div>
            </motion.div>
